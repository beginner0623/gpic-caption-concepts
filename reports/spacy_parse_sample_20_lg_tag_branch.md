...
| t2 | 0 | referee | referee | PROPN | NNP | ROOT | referee | 0 | 24:31 |
...
| tag_id | i | text | lemma | pos | tag | dep | head | head_i | char_span |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| t0 | 0 | brown | brown | PROPN | NNP | compound | boot | 1 | 0:5 |
...
| id | type | source | target | confidence | evidence |
| --- | --- | --- | --- | --- | --- |
| e0 | has_attribute | m0 | m1 | high | t0 internal compound -> boot |
