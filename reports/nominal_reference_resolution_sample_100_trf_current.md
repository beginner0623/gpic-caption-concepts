...
| item | count |
| --- | ---: |
| `copy_antecedent_type_apply_modifiers` | 4 |
...
| ---: | --- | --- | --- | --- | ---: | ---: | --- | --- | --- | --- |
| 15 | `One` | `singular_substitute` |  | Two men | 118 | 70 | `resolved` | `high` | `copy_antecedent_type_apply_modifiers` | recent, previous_sentence, plural_source_for_substitute, has_quanti... |
...
| 63 | `One` | `singular_substitute` |  | Two men | 118 | 41 | `resolved` | `high` | `copy_antecedent_type_apply_modifiers` | recent, previous_sentence, plural_source_for_substitute, has_quanti... |
...
| 89 | `one` | `singular_substitute` |  | Two men | 119 | 77 | `resolved` | `high` | `copy_antecedent_type_apply_modifiers` | very_recent, same_sentence, plural_source_for_substitute, has_quant... |
